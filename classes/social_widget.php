        ...
        public function widget( $args, $instance ) {
            ...
            echo $before_title . $title . $after_title; ?>
                <ul class="social-list">
                    <?php if (get_theme_mod( 'medialon_facebook')): ?>
                        <li class="facebook">
                            <a href="<?php echo get_theme_mod( 'medialon_facebook'); ?>" target="_blank">
                                <img src="<?php bloginfo('template_directory'); ?>/assets/facebook.png" />
                            </a>
                        </li>
                    <?php endif; ?>
                    <?php if (get_theme_mod( 'medialon_twitter')): ?>
                        <li class="twitter">
                            <a href="<?php echo get_theme_mod( 'medialon_twitter'); ?>" target="_blank">
